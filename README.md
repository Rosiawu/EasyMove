...
- 悬停文件或文件夹整行 400ms 显示即时预览；不必精确移到图标上
- 单击任意文件或文件夹会在右侧打开固定预览窗格，展示真实内容、文件夹摘要和元数据，并可直接打开项目
- 文件夹双击进入；选择后的右侧预览也提供“打开文件夹”入口
- 开始拖拽、剪切或移动文件时自动收起预览，恢复完整的目标窗格空间
...
当前 0.3.2 安装包支持 Apple Silicon（M1/M2/M3/M4/M5）Mac。打开 DMG，将 EasyMove 拖到“应用程序”。
